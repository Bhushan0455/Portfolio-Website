...
export default function MomentsMilestones() {
  ...
  return (
    <section id="milestones" aria-labelledby="milestones-title" className="pt-10 md:pt-12 pb-16 md:pb-24 bg-white dark:bg-[#081220] relative overflow-hidden select-none border-t border-b border-border/20 dark:border-white/5">
